...
//               Turn your <span className="text-black-700">spoken words</span>{" "}
//               into a{" "}
//               <span className="text-black-600">beautiful product catalog</span>.
//             </h1>
...
//                 {/* <div
//                   className="rounded-2xl bg-gradient-to-br from-violet-100 via-amber-50 to-sky-100
...
//                   />
//                 </div> */}
//                 <div className="relative image-realism">
//                   <img
//                     src="/vendor-image.png"
//                     alt="Vendor using voice to create a product catalog"
...
//                 Designed to make catalog creation effortless for shop owners,
//                 small vendors, and rural businesses — all through simple voice
//                 commands.
//               </p>
//             </div>
...
//                   Speak naturally in your local language — the system
//                   understands your accent, mixed speech, and real shop
//                   environment.
//                 </p>
//               </div>
...
//                 </h3>
//                 <p className="text-slate-600 text-sm leading-relaxed">
//                   Product name, price, units, brand, quantity — everything is
//                   detected automatically from your speech.
//                 </p>
//               </div>
...
//                 </h3>
//                 <p className="text-slate-600 text-sm leading-relaxed">
//                   Automatically formats clean product cards ready to share on
//                   WhatsApp, printouts, or digital catalogs.
//                 </p>
//               </div>
...
//                 </h3>
//                 <p className="text-slate-600 text-sm leading-relaxed">
//                   Create an entire digital catalog 3× faster than manual typing.
//                   Update prices and products instantly.
//                 </p>
//               </div>
...
//                 </h3>
//                 <p className="text-slate-600 text-sm leading-relaxed">
//                   Edit product cards instantly with voice or touch — pricing,
//                   quantity, descriptions & images update live.
//                 </p>
//               </div>
...
//                 </h3>
//                 <p className="text-slate-600 text-sm leading-relaxed">
//                   Vendor data stays encrypted and private — safe from misuse,
...
//               <p className="text-slate-600 text-sm max-w-2xl mx-auto">
//                 Voice Catalog Agent listens as you describe your products and
//                 converts your natural speech into clean, shareable product cards
//                 automatically.
//               </p>
//             </div>
...
//                   Vendor opens the app and selects{" "}
//                   <strong>“Add product by voice.”</strong>
...
//                 </h3>
//                 <p className="text-slate-600 leading-relaxed text-center">
//                   Vendor speaks product name, price, size, brand, and any
//                   details in their own language—just like talking to a customer.
//                 </p>
//               </div>
...
//                 </h3>
//                 <p className="text-slate-600 leading-relaxed text-center">
//                   Speech is transcribed, cleaned, and analyzed. The system
//                   extracts fields automatically and suggests tags.
//                 </p>
//               </div>
...
//                 </h3>
//                 <p className="text-slate-600 leading-relaxed text-center">
//                   Vendor quickly reviews and saves. The product instantly
//                   appears in their digital catalog—ready to share.
//                 </p>
//               </div>
//             </div>
//           </div>
...
//             <div className="text-center mb-14">
//               <h2 className="text-3xl font-semibold mb-3">
//                 Simple, vendor-first pricing
//               </h2>
//               <p className="text-slate-600 max-w-2xl mx-auto">
//                 Start free while you build your catalog. Upgrade only when
//                 you&apos;re ready for advanced controls, analytics, and more
//                 shops under the same account.
//               </p>
//             </div>
...
//                 </p>
//                 <p className="text-xs text-slate-600 mb-4">
//                   Perfect for a single shop owner getting their first full
//                   digital catalog.
//                 </p>
//                 <ul className="text-xs text-slate-700 space-y-2 mb-6 list-disc list-inside">
...
//                 </p>
//                 <p className="text-xs text-slate-600 mb-4">
//                   Concept plan for multiple branches, analytics and
//                   integrations.
//                 </p>
//                 <ul className="text-xs text-slate-700 space-y-2 mb-6 list-disc list-inside">
...
//                   Many small shop owners are left behind in the digital economy
//                   because tools expect typing, English skills, and complex phone
//                   usage. This project is focused on reducing that gap and making
//                   catalog creation as natural as speaking to a customer.
//                 </p>
//                 <p className="text-slate-600 leading-relaxed text-[14px]">
//                   Whether it&apos;s a kirana store, hardware shop, or small
//                   clothing vendor, they can all speak their way into the digital
//                   world with minimal friction and maximum comfort.
//                 </p>
//               </div>
...
//                   </span>
//                   <p className="text-slate-700 leading-relaxed">
//                     Designed for low-tech users who are more comfortable
...
//                   </span>
//                   <p className="text-slate-700 leading-relaxed">
//                     Catalogs can be shared on WhatsApp, printed, or shown to
//                     walk-in customers.
//                   </p>
//                 </div>
...
//                   </span>
//                   <p className="text-slate-700 leading-relaxed">
//                     Mobile-first experience that works even on basic Android
//                     smartphones.
//                   </p>
//                 </div>
//               </div>
...
//                   &quot;I just speak once, and my whole catalog is ready to
//                   share.&quot;
//                 </p>

//                 <p className="text-xs text-slate-600 leading-relaxed pl-6">
//                   Earlier I used to write prices in a notebook and send photos
//                   on WhatsApp. Now the system remembers everything and updates
//                   prices instantly.
//                 </p>
...
//               simple voice-based product cataloging — no typing, no tech skills
//               needed.
//             </p>

//             <p className="text-xs text-slate-500 mt-4">
//               © {new Date().getFullYear()} Voice Catalog Agent. All rights
//               reserved.
//             </p>
//           </div>
...
//               </li>
//               <li>
//                 <a href="#vendors" className="hover:text-violet-400 transition">
//                   For Vendors
//                 </a>
//               </li>
//             </ul>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100 transition-colors duration-300">
      ...
      <header className="bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="h-9 w-9 rounded-xl bg-violet-600 flex items-center justify-center text-white font-bold">
              VC
            </div>
            <p className="font-semibold text-sm">Voice Catalog</p>
          </div>
          ...
          <div className="flex gap-3 text-sm">
            ...
            <Link
              to="/auth/signup"
              className="px-4 py-1.5 rounded-full bg-violet-600 text-white hover:bg-violet-500"
            >
              Sign Up
            </Link>
          </div>
      ...
      {/* ================= MAIN ================= */}
      <main className="flex-1">
        {/* ================= HERO (LEFT CONTENT + FULL RIGHT IMAGE) ================= */}
        <section className="min-h-[calc(100vh-64px)] bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 h-full grid md:grid-cols-2 items-center gap-10">
            {/* ---------- LEFT CONTENT ---------- */}
            <FadeInSection>
              <div>
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold leading-snug text-slate-900">
                  ...
                  <br />
                  <span className="text-violet-600">just by speaking</span>
                </h1>

                <p className="mt-5 text-sm sm:text-base text-slate-600 max-w-xl">
                  This app helps shop owners create a digital catalog without
                  typing. Just speak your product name, price and details like
                ...
                <div className="mt-7 flex gap-4">
                  <Link
                    to="/auth/signup"
                    className="px-6 py-2.5 rounded-full bg-violet-600 text-white text-sm hover:bg-violet-500 shadow-sm"
                  >
                    Start Free
                  </Link>
                  ...
                  <Link
                    to="/auth/login"
                    className="px-6 py-2.5 rounded-full border border-slate-300 text-sm hover:bg-slate-100 bg-white"
                  >
                ...
                {/* SIMPLE INFO BOXES */}
                <div className="mt-10 grid gap-4 sm:grid-cols-3 text-sm max-w-xl">
                  <div className="bg-white border rounded-xl p-4 shadow-sm">
                    🎙
                    <p className="font-semibold mt-2">Speak naturally</p>
                    <p className="text-xs text-slate-600">
                      Talk like you talk to customers
                    </p>
                  </div>

                  <div className="bg-white border rounded-xl p-4 shadow-sm">
                    🧠
                    <p className="font-semibold mt-2">Auto-filled details</p>
                    <p className="text-xs text-slate-600">
                      Name & price detected automatically
                    </p>
                  </div>

                  <div className="bg-white border rounded-xl p-4 shadow-sm">
                    📲
                    <p className="font-semibold mt-2">Share easily</p>
                    <p className="text-xs text-slate-600">
            ...
            {/* ---------- RIGHT IMAGE (FULL HEIGHT + FLOATING) ---------- */}
            <FadeInSection>
              <div className="relative h-full flex items-center justify-center">
                {/* Soft background glow */}
                <div className="absolute inset-0 bg-gradient-to-br from-violet-100 via-sky-100 to-transparent opacity-50 blur-3xl"></div>
                ...
                <img
                  ...
                  className="
            relative
            h-[80vh]              /* ✅ fills right side vertically */
            max-h-[700px]
            w-auto
            object-contain
            animate-float-slow    /* ✅ smooth up-down animation */
            drop-shadow-xl
          "
                />
              </div>
